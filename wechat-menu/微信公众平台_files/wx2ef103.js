...
function n(o,a,n){
var r,e;
n&&"object"==typeof n?(r=n.done,e=n.fail):r=n,"string"==typeof a&&a.length>0&&(a={
url:a
}),a=$.extend(!0,{},c,{
type:o,
data:{
...
e&&e(n),s.error(n,a),m.trigger("xhrError",o,n,t,a);
}).always(function(){
a.mask&&t.hide();
}),i;
}
var t=o("common/qq/mask.js"),r=o("common/wx/dialog.js"),e=o("common/wx/Tips.js"),s=o("common/wx/cgiReport.js");
...
return 0==o.base_resp.ret?void(a?r.show({
type:"succ",
msg:"系统提示|"+n
}):e.suc(n)):void(a?r.show("系统错误|"+n):e.err(n));
};
