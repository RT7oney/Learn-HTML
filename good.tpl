  ...
  <section class="vbox">
    <header class="bg-white header header-md navbar navbar-fixed-top-xs box-shadow">
      ...
      <ul class="nav navbar-nav navbar-right m-n hidden-xs nav-user user">
            ...
            <b href="#" class="btn zy-h-btn">充值</b>
        		</a>
        </li>
        <li class="hidden-xs">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown">
            <i class="glyphicon glyphicon-bell zy-t-icon"></i>
              ...
              <div class="list-group list-group-alt">
                <a href="#" class="media list-group-item">
                  <span class="pull-left thumb-sm">
                    <img src="./public/assets/images/a0.png" alt="..." class="img-circle">
                  </span>
        ...
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown">
            <span class="zy-name">John.Smith</span>你好 <b class="caret"></b>
          </a>
                        ...
                        <div class="panel-body">
                          ...
                          <div class="m-b">
                            <a href="#" class="avatar thumb-sm">
                              <img src="./public/assets/images/a0.png" alt="...">
                              <i class="on b-white"></i>
                            </a>
                            <a href="#" class="avatar thumb-sm">
                              <img src="./public/assets/images/a1.png" alt="...">
                              <i class="busy b-white"></i>
                            </a>
                            <a href="#" class="avatar thumb-sm">
                              <img src="./public/assets/images/a2.png" alt="...">
                              <i class="away b-white"></i>
                            </a>
                            <a href="#" class="avatar thumb-sm">
                              <img src="./public/assets/images/a3.png" alt="...">
                        ...
                        <ul class="list-group list-group-lg no-bg auto">
                          <a href="#" class="list-group-item clearfix">
                            <span class="pull-left thumb-sm avatar m-r">
                              <img src="./public/assets/images/a4.png" alt="...">
                          ...
                          <a href="#" class="list-group-item clearfix">
                            <span class="pull-left thumb-sm avatar m-r">
                              <img src="./public/assets/images/a5.png" alt="...">
                              <i class="on b-white bottom"></i>
                            </span>
                            <span class="clear">
                          ...
                          <a href="#" class="list-group-item clearfix">
                            <span class="pull-left thumb-sm avatar m-r">
                              <img src="./public/assets/images/a6.png" alt="...">
                          ...
                          <a href="#" class="list-group-item clearfix">
                            <span class="pull-left thumb-sm avatar m-r">
                              <img src="./public/assets/images/a7.png" alt="...">
                    ...
                    <li class="list-group-item">
                      <div class="media">
                        <span class="pull-left thumb-sm avatar">
                          <img src="./public/assets/images/a3.png" alt="..." class="img-circle">
